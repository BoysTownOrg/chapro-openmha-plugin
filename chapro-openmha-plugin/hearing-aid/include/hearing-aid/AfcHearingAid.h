...
public:
    ...
    virtual void feedbackCancelInput(real_type *, real_type *, real_signal_type, real_signal_type, int) = 0;
    virtual void compressInput(real_type *, real_type *, real_signal_type, real_signal_type, int) = 0;
    virtual void filterbankAnalyze(real_signal_type, real_type *, complex_signal_type, int) = 0;
    virtual void compressChannel(complex_signal_type, complex_signal_type, int) = 0;
    virtual void filterbankSynthesize(complex_signal_type, real_type *, real_signal_type, int) = 0;
    virtual void compressOutput(real_type *, real_type *, real_signal_type, real_signal_type, int) = 0;
    virtual void feedbackCancelOutput(real_type *, real_signal_type, int) = 0;
